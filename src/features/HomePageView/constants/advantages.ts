...
export const advantages: ReadonlyArray<IAdvantage> = [
  {
    ...
    description:
      'Цифрові версії документів скорочують час обробки запитів студентів, автоматично розподіляючи їх між адміністраторами.',
  ...
  },
  {
    ...
    description:
      'Веб-додаток дозволяє студентам подавати запити та  отримувати відповіді з будь-якого місця, де є Інтернет.',
