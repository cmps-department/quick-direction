  ...
  return (
    <Menu position="bottom-start" offset={10} arrowPosition="center">
      ...
      <Menu.Dropdown style={{ borderRadius: '24px' }}>
        <Menu.Item
          component="button"
          onClick={() => changeSortingData(EnumSortings.Alphabetical)}
        ...
        <Menu.Item
          component="button"
          onClick={() => changeSortingData(EnumSortings.NonAlphabetical)}
          className={styles.menuItem}
        >
          Від Я до А
        </Menu.Item>
        <Menu.Item
          component="button"
          onClick={() => changeSortingData(EnumSortings.CreationTime)}
          className={styles.menuItem}
        >
          За часом створення
        </Menu.Item>
