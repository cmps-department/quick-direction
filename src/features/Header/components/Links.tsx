    ...
    const renderLinks = () => {
        if (session?.roles.includes("ROLE_ADMIN")) {
            ...
            return (
                <>
                    {
                        router.pathname.startsWith("/request-processing")
                            ? null
                            : (
                                <Indicator styles={{ indicator: { height: "10px", width: "10px", top: "3px", right: "-5px" }}} color="#E4FDE0">
            ...
            return (
                <>
                    ...
                    {
                        router.pathname.startsWith("/request-directions")
                            ? null 
                            : (
